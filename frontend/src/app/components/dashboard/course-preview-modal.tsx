...
export function CoursePreviewModal({
  ...
  const reviews = [
    {
      ...
      name: 'Saman Perera',
      rating: 5,
      comment: 'Excellent teaching methods and very comprehensive content. Highly recommended!',
      date: 'January 2026',
    },
    {
      id: 2,
      name: 'Nimesha Silva',
      rating: 5,
      comment: 'Best class I have ever attended. The teacher explains concepts very clearly.',
      date: 'December 2025',
    },
    {
      id: 3,
      ...
      rating: 4,
      comment: 'Great course structure and excellent study materials provided.',
      date: 'November 2025',
    },
  ];
  ...
  const courseStats = [
    ...
    { icon: BookOpen, label: 'Lessons', value: '48 Classes' },
    { icon: Award, label: 'Certificate', value: 'Included' },
    { icon: Users, label: 'Enrolled', value: `${course.studentsEnrolled}` },
  ];
