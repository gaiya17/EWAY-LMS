  ...
  const recentNotifications = [
    {
      ...
      description: 'Physics - Chapter 5 homework due Friday',
      time: '2 hours ago',
      type: 'Academic',
      unread: true,
      icon: '📚',
    },
    {
      ...
      description: 'Mathematics class moved to 3:00 PM',
      time: '5 hours ago',
      type: 'Classes',
      unread: true,
      icon: '📅',
    },
    {
      ...
      description: 'Your payment for June has been confirmed',
      time: '1 day ago',
      type: 'Payment',
      unread: false,
      icon: '💳',
                ...
                {recentNotifications.map((notification) => (
                  <div
                    ...
                    className={`p-4 border-b border-white/5 hover:bg-white/5 transition-colors cursor-pointer ${
                      notification.unread ? 'bg-blue-500/5 border-l-2 border-l-cyan-400' : ''
                    }`}
                  >
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white/60 text-xs mb-2">{notification.description}</p>
