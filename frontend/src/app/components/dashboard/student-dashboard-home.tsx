            ...
            <div className="flex items-center justify-between">
              ...
              <div className="hidden xl:flex flex-col items-center gap-4">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-gradient-to-r from-indigo-500 to-cyan-400 text-white text-sm font-bold">
                    ID: 12345
                  </div>
                </div>
              </div>
